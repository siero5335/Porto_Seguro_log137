...
##max.depth = 4.0000	min_child_weight = 9.0000	subsample = 0.6295
##colsample_bytree = 0.6212	alpha = 0.8327	lambda = 0.7775	Value = 0.6422
...
write.table(sub, "xgboost_stratifiedCV_tsnesBopt3mix.csv", sep=",", dec=".", quote=FALSE, row.names=FALSE)
