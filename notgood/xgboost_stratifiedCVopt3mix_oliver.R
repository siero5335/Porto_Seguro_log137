...
##max.depth = 4.0000	min_child_weight = 5.0000	subsample = 0.6631	colsample_bytree = 0.7000
##gamma = 0.0000	alpha = 0.8898	lambda = 1.0000
...
write.table(sub, "xgboost_stratifiedCVBopt3mix_oliver.csv", sep=",", dec=".", quote=FALSE, row.names=FALSE)
...
write_csv(as.data.frame(train_pred_targets_xgb), "train_pred_targets_xgboost_stratifiedCVopt3mix_oliver.csv")
write_csv(as.data.frame(test_pred_targets_xgb), "test_pred_targets_xgboost_stratifiedCVopt3mix_oliver.csv")